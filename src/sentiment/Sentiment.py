...
class Sentiment():
    ...
    def check(self):
        ...
        #     q=search_term, lang='en', since='2022-01-01', tweet_mode='extended')

        search_result = api.search_tweets(
            q=search_term, lang='en', tweet_mode='extended')
        ...
        # TODO: return the "Sentiment"
        # Define the business logic based on the Sentiment
        # Positive > Neutral => "Buy"
        ...
        title = str(f"sentiment-{time.time()}.png")
